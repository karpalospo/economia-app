...
const styles = StyleSheet.create({
    ...
    container: {backgroundColor: COLORS._F2F2F2, borderRadius: 15, width: '100%', marginVertical: 10, shadowRadius: 7.5, shadowOpacity: 0.27, shadowOffset: {width: 0, height: 6}, shadowColor: COLORS._657272, elevation: 12},
    ...
    titleText: { fontSize: 20, fontFamily: FONTS.BOLD, color: COLORS._FFFFFF, marginLeft: 20 },
